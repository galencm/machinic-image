...
class SlurpPrimitiveVirtualCamera(object):
    ...
    def discover(self):
        ...
        matched = self.r.scan_iter("{}:*".format(self.method))
        ...
        try:
            ...
            for match in matched:
                ...
                discoverable.append({'name':name,'address':source,'uid':name, 'discovery_method': self.method,'lastseen':now})
